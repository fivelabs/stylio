...
export default function BillingPage() {
  ...
  return (
    <div className="p-8 max-w-2xl space-y-4">
      <div>
        <h1 className="font-heading text-2xl font-bold text-accent">Facturación</h1>
        <p className="text-text-primary/50 text-sm mt-1">
          Administra tu suscripción y datos de pago.
        </p>
      </div>
        ...
        <div className="px-6 py-5 border-b border-border">
          ...
          {sub ? (
            <>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="flex items-start gap-3">
                  <CalendarBlankIcon size={18} className="text-text-primary/40 mt-0.5 shrink-0" />
                  <div>
                ...
                <div className="flex items-start gap-3">
                  <IdentificationCardIcon size={18} className="text-text-primary/40 mt-0.5 shrink-0" />
                  <div>
                    <p className="text-xs font-semibold text-text-primary/40 uppercase tracking-wider mb-0.5">
                      ID de suscripción
                    </p>
                    <p className="text-xs font-mono text-text-primary/70 break-all">{sub.id}</p>
                  </div>
                </div>
              </div>
            </>
            ...
            <div className="flex items-center gap-3 py-2">
              <CrownSimpleIcon size={22} className="text-text-primary/30" />
          ...
          {sub ? (
            <>
              ...
              >
                ...
                <ArrowSquareOutIcon size={13} className="text-text-primary/40" />
              </button>
            ...
            <button
              onClick={() => openPortal()}
              disabled={working}
              className="flex items-center gap-2 text-sm font-semibold px-4 py-2.5 rounded-xl bg-brand text-white hover:bg-brand-dark transition-colors disabled:opacity-50"
            >
              <CrownSimpleIcon size={15} weight="bold" />
              Activar suscripción
            </button>
          )}
        </div>
