...
import { ScissorsIcon, XIcon } from "@phosphor-icons/react";
import { servicesService } from "@/api/services.service";
import { INPUT_CLASS } from "@/features/dashboard/appointments/helpers";

export default function QuickCreateServiceModal({ initialName, onClose, onCreated }) {
    ...
    <div className="fixed inset-0 z-[60] flex items-end sm:items-center justify-center">
      ...
      <div className="relative bg-canvas rounded-2xl shadow-2xl w-full max-w-sm mx-4 mb-4 sm:mb-0 overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="px-5 py-4 space-y-3">
          ...
          <div>
            <label className="block text-[13px] font-medium text-text-primary/60 mb-1.5">Precio</label>
